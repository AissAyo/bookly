...
<head>
<meta charset="UTF-8">
<title>read-Book-free-in-Bookly</title>
                     ...
                     <figure>
                        ...
                        <div class="portfolio_text">
                           <div class="li_icon">
                              ...
                              <a href="https://www.dbooks.org/d/5709901124-1736390523-ec68b0dd40a69423/"><span>Download</span></a>
                           </div>
...
- Product tests. The best media player equipment tested.</p>
                     ...
                     <figure>
                        ...
                        <div class="portfolio_text">
                           <div class="li_icon">
                              ...
                              <a href="https://www.dbooks.org/d/199013209X-1736390541-79e5b30647b1a4c2/"><span>Download</span></a>
                           </div>
                     ...
                     <figure>
                        ...
                        <div class="portfolio_text">
                           <div class="li_icon">
                              ...
                              <a href="https://www.dbooks.org/d/1805112015-1736390574-be7174d2979fad22/"><span>Download</span></a>
                           </div>
               ...
               <div class="col-md-6">
                  <div id="ho_nf" class="portfolio_main text_align_left">
                     <figure>
                        <img src="<%= request.getContextPath() %>/template/images/img6.jpg" alt="#"/>
                        <div class="portfolio_text">
                           <div class="li_icon">
                              <a href="https://www.dbooks.org/managing-cloud-native-data-on-kubernetes-1098111389/read/"><span>Read Now</span></a>
                              <a href="https://www.dbooks.org/d/1098111389-1736390654-1ba62ba6c75ab15d/"><span>Download</span></a>
                           </div>
                           <h3>Managing Cloud Native Data on Kubernetes</h3>
...
This open access book is Complimented by PortWorx. You can download Managing Cloud Native Data on Kubernetes ebook for free in PDF format (8.0 MB)..</p>
                        </div>
                     </figure>
                  </div>
               </div>
         ...
         <!-- boook jdid -->
               ...
               <div class="col-md-6">
                  <div id="ho_nf" class="portfolio_main text_align_left">
                     <figure>
                        <img src="<%= request.getContextPath() %>/template/images/img7.jpg" alt="#"/>
                        <div class="portfolio_text">
                           <div class="li_icon">
                           ...
                           The result is minimal and highly optimized pure JavaScript that the browser executes with no heavy runtime. In Svelte Succinctly, Ed Freitas will 
                           show readers how to install Svelte and give them a condensed overview of how to build an app with Svelte using SvelteKit.	
							This open book is licensed under a Open Publication License (OPL). You can download Svelte Succinctly ebook for free in PDF format (5.2 MB).</p>
                        </div>
                     </figure>
                  </div>
               </div>
